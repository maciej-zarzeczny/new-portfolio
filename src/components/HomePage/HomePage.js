    ...
    <section className={styles.page}>
      <div className="container">
        <header className={styles.header}>
          <div>
            <h3 className={styles.title}>Maciej Zarzeczny</h3>
            <h1 className={styles.headerText}>Frontend developer</h1>
            <h1 className={styles.headerText}>Mobile developer</h1>
